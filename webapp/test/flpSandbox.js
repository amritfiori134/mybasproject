		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo BAS Project",
									"targetURL": "#mydemobasprojectmydemobasproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mydemobasprojectmydemobasproject-display": {
								"semanticObject": "mydemobasprojectmydemobasproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mydemobasproject.mydemobasproject",
									"url": sap.ui.require.toUrl("mydemobasproject/mydemobasproject")
								}
							}
						}
					}
